...
<head>
    ...
    <title>Presentation Making Registration</title>
...
<body class="bg-gradient-to-b from-black via-purple-900 to-black text-white font-sans">
    ...
    <main class="flex justify-center items-center mt-20 mb-5  ">
        <form action="submi.php" method="POST" class="bg-gradient-to-br from-purple-800 via-indigo-900 to-black p-10 rounded-xl shadow-xl w-4/5 max-w-lg border border-gray-700">
            <input type="hidden" name="event" value="Presentation Making">
            <h2 class="text-3xl font-semibold text-center mb-6">Join Presentation Making Now!</h2>
